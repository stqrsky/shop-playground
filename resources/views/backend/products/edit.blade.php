        ...
        <div class="tile-body">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="control-label">{{ $errors->first('description') }}</label>
                        <textarea class="form-control" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label">{{ $errors->first('price') }}</label>
                        <input class="form-control" type="text">
                    </div>
                    <div class="form-group">
                        <label class="control-label">{{ $errors->first('msrp') }}</label>
                        <input class="form-control" type="text">
                    </div>
                    <div class="form-group">
                        <label class="control-label">{{ $errors->first('stock') }}</label>
                        <input class="form-control" type="text">
                    </div>
                </div>
                <div class="col-md-4">
